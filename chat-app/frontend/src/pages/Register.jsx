...
import { MessageSquare, User, Mail, Lock, Loader2, AlertCircle } from 'lucide-react';
...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-zinc-50 dark:bg-slate-950 text-slate-900 dark:text-white transition-colors duration-300 relative">
      ...
      <div className="absolute top-10 right-10 w-80 h-80 rounded-full bg-primary-500/10 blur-[100px] pointer-events-none" />
      ...
      <div className="w-full max-w-md glass p-8 rounded-3xl shadow-2xl z-10">
        ...
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <p className="text-xs text-slate-400 dark:text-slate-500 mt-1">Get started sharing text, files, and video streams in real-time.</p>
        </div>
