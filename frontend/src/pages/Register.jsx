...
import { FileText, User, Mail, Lock, Loader2, AlertCircle } from 'lucide-react';
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!username || !email || !password || !confirmPassword) {
      setValidationError('Please fill in all the registration fields.');
      return;
    }
  ...
  return (
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center px-4 py-12 bg-zinc-50 dark:bg-slate-950 text-slate-900 dark:text-white transition-colors duration-300 relative">
      ...
      <div className="absolute top-10 right-10 w-72 h-72 rounded-full bg-primary-500/10 blur-[100px] pointer-events-none" />
      <div className="absolute bottom-10 left-10 w-72 h-72 rounded-full bg-indigo-500/10 blur-[100px] pointer-events-none" />
      ...
      <div className="w-full max-w-md glass p-8 rounded-3xl shadow-xl z-10 transition-colors duration-300">
        ...
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <p className="text-xs text-slate-400 dark:text-slate-500 mt-1">Get started build high-fidelity professional resumes.</p>
        </div>
